...
public class POJO_deserialize {
    ...
    public void gson_example(){
        ...
        //fromJson() -->jsondan datayı getirim map veya POJO ya çevirir
        Spartan spartan15 = gson.fromJson(myJsonData,Spartan.class);
        System.out.println(spartan15);

        //gson, json dan datayı alıyor ve bunu map veya istediğin classa çeviriyor.
        //yukarda gson, jsondan datayı aldı ve map çevirdi
        //ayrıca gson, jsondan datayı aldı POJO ya çevirdi, spartan classa çevirdi.

        //-----------------SERIALİZATION---------------
        //JAVA Collection or POJO to JSON
        Spartan spartanEU = new Spartan(200,"Mike","Male",123123123);

        //toJson()-->map veya POJO dan datayı getirim json a çevirir
        String jsonSpartanEU = gson.toJson(spartanEU);
        System.out.println(jsonSpartanEU);


        //yukardakileri aslınd as() yapıyor. anlamak için yukardakini manual yaptık
