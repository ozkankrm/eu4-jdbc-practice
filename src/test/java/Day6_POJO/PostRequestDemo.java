 ...
 */
    ...
    public void PostNewSpartan(){
        ...
        Response response = given().log().all()
                            ...
                            .and()
                            .body(jsonBody)//requestteki body ye formatı yerleştirdik
                .when()
                            .post("/api/spartans");
    ...
    public void PostNewSpartan2(){
        ...
        given().log().all()
                ...
                .contentType(ContentType.JSON)
                .and()
                .body(requestMap) //burda java otomatikmen jsona dönüşüyor
        .when()
                .post("/api/spartans")
        .then().log().all()
                .statusCode(201)
    ...
    public void PostNewSpartan3(){
        ...
        Spartan spartanEU4 = new Spartan();
        spartanEU4.setName("MikeEU4");
        spartanEU4.setGender("Male");
        spartanEU4.setPhone(8877445596l);
        ...
        given().log().all()
                ...
                .contentType(ContentType.JSON)
                .and()
                .body(spartanEU4) //burda java otomatikmen jsona dönüşüyor
                .when()
                .post("/api/spartans")
                .then().log().all()
                .statusCode(201)
